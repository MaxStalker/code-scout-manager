...
pub contract CryptoPiggoV2: NonFungibleToken {
    ...
    pub fun resolveView(_ view: Type): AnyStruct? {
      switch view {
        ...
        case Type<MetadataViews.ExternalURL>():
          return MetadataViews.ExternalURL("https://s3.us-west-2.amazonaws.com/piggos-2/".concat(self.id.toString()).concat(".png"))
        ...
        case Type<MetadataViews.NFTCollectionDisplay>():
          let media = MetadataViews.Media(
            file: MetadataViews.HTTPFile(url: "https://s3.us-west-2.amazonaws.com/piggos-2/banner.png"),
            mediaType: "image/png"
          )
  ...
  init() {
    ...
    self.account.link<&CryptoPiggoV2.Collection>(
